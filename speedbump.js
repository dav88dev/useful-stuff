...
$(document).ready(function(){
            document.body.innerHTML += '<div class="modal fade" tabindex="-1" role="dialog" id="speedbump"><div class="modal-dialog"><div class="modal-content"> <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">Warning</h4></div><div class="modal-body"><p>Text here.</p></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" onclick="openLink()" class="btn btn-danger">Open link</button></div></div></div></div>';
