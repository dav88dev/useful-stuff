//Insert Bootstrap modal into body and speedbump on jQuery
    ...
    $(document).ready(function(){
        $('.someClass').append('<div class="modal fade" tabindex="-1" role="dialog" id="speedbump"><div class="modal-dialog"><div class="modal-content"> <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h4 class="modal-title" style="color: black">Warning</h4></div><div class="modal-body"><p style="color: black">You are leaving !</p></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><button type="button" onclick="openLink()" class="btn btn-danger">OK</button></div></div></div></div>');
